...
import { createSinglePostAction } from "../redux/actions/postActions";
...
const CreateAPost = () => {
    ...
    const { message, error } = useSelector((state) => state.postReducer);
    ...
    const submitHandler = async (e) => {
        ...
        if (!file && !content) {
            ...
            return toast.error("please add content or upload file");
        }
        ...
        await dispatch(createSinglePostAction(formData));
        setButtonLoading(false);
    };
